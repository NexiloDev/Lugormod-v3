...
void G_WriteClientSessionData(gclient_t* client)
{
    ...
    s = va("%i %i %i %i %i %i %i %i %i %i %i %i %s %s %s %i %i",
           ...
           saberType,
           saber2Type,
           client->sess.Lmd.forcedTeam,
           client->sess.Lmd.forcedTeamExpires);
...
void G_ReadSessionData(gclient_t* client)
{
    ...
    fields = sscanf(s, "%i %i %i %i %i %i %i %i %i %i %i %i %s %s %s %i %i",
...
void G_InitSessionData(gclient_t* client, char* userinfo, qboolean isBot, qboolean newSession)
{
    ...
    sess->Lmd.forcedTeam = TEAM_NUM_TEAMS;
    sess->Lmd.forcedTeamExpires = 0;
